...
class Personal_civil extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view("admin/personal_civil/list", $data);
	...
	public function add()
	{
		...
		$this->load->view("layouts/header");
		$this->load->view("layouts/aside");
		$this->load->view("admin/personal_civil/add");
		$this->load->view("layouts/footer");
	}
	...
	public function store()
	{
		...
		if ($this->upload->do_upload($mi_imagen)) {
			...
			redirect(base_url() . "control/personal_civil/add/");
		}
	}
	...
	{
		$data  = array(
			'personal_civil' => $this->Categorias_model->getCategoria($id),
		);
		$this->load->view("layouts/header");
		$this->load->view("layouts/aside");
		$this->load->view("admin/personal_civil/edit", $data);
		$this->load->view("layouts/footer");
	}
	...
	public function view()
	{
		...
		$this->load->view("admin/personal_civil/view", $data);
	}
}
