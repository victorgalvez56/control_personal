...
<div class="row">
	...
	<table>
		<tr>
			<td vertical-align: left> <img height="50" width="50" src=https://4.bp.blogspot.com/-2-f2OaR77Bw/WMfG7feqALI/AAAAAAAArGU/hVX5fQw1LrYtw6Su6kKphan1XeCd-Dl-wCLcB/s1600/III%2BDIV%2BEJTO.jpg> </td> <td width="400">
				<H4>III DIVISIÓN EJÉRCITO AREQUIPA </H4>
			</td>
			<td> <img height="50" width="50" src=https://upload.wikimedia.org/wikipedia/commons/thumb/0/0c/Emblem_of_the_Peruvian_Army.svg/374px-Emblem_of_the_Peruvian_Army.svg.png> </td> </tr> </table> <table>
				<thead>
	...
	<table>
		<thead>
			...
			<?php foreach ($detalleFamiliar as $familiar) : ?>
				<tr>
					<td><?php echo $familiar->nombre_fam; ?></td>
					<td><?php echo $familiar->parentesco_fam; ?></td>
					<td><?php echo $familiar->edad_fam; ?></td>
					<td><?php echo $familiar->fecha_nac_fam; ?></td>
					<td><?php echo $familiar->lugar_nac_fam; ?></td>
				...
				<tr>
					<td><?php echo $familiar->cip_fam; ?></td>
					<td><?php echo $familiar->dni_fam; ?></td>
					<td><?php echo $familiar->telef_fam; ?></td>
					<td><?php echo $familiar->grup_sang_fam; ?></td>
					<td><?php echo $familiar->grad_inst_fam; ?></td>
				</tr>
			<?php endforeach; ?>
	...
	<table>
		<thead>
			...
			<td><?php echo $idioma->idioma; ?></td>
				<td><?php echo $idioma->habla; ?></td>
				<td><?php echo $idioma->lee; ?></td>
				<td><?php echo $idioma->escribe; ?></td>
				<td><?php echo $idioma->adquirido; ?></td>
				<td><?php echo $idioma->graduado; ?></td>
	...
	<table>
		<thead>
			...
			<tr>
				<td><?php echo $estudio->curso; ?></td>
				<td><?php echo $estudio->tipo_curso; ?></td>
	...
	<table>
		<thead>
			...
			<tr>
				...
				<td><?php echo $seguro->tipo_seguro; ?></td>
			</tr>
			<?php endforeach; ?>
