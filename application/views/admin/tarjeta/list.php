                                ...
                                <?php if (!empty($personals)) : ?>
                                    <?php foreach ($personals as $personal) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-info btn-view-tarjeta" value="<?php echo $personal->id; ?>" data-toggle="modal" data-target="#modal-default"><span class="fa fa-search"></span></button>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
