...
<script>
  ...
  $(document).on("click", ".btn-view-tarjeta", function() {
    ...
    $.ajax({
      ...
      success: function(data) {
        $("#modal-default .modal-body").html(data);
        const barcodetarjeta = $("#dniBarcodeTarjeta").val()
        $("#barcode").JsBarcode(String(barcodetarjeta), {
          width: 2,
          height: 100,
          quite: 10,
          format: "CODE128",
  ...
  $(document).ready(function() {
    ...
    $(document).ready(function() {
      if ($('#auxdisablebutton').val() == '8') {
        $('#buttonpushheader').removeClass('sidebar-toggle');

      }
      console.log($('#auxdisablebutton').val())
    });
    ...
    $('#btn_datospersonales_details').click(function() {

      $('#datospersonales_details').removeClass('active');
      $('#datosmensuales_details').addClass('active in');
      $('#datosanuales_details').addClass('active in');

    });
    $('#previous_btn_datospersonales_details').click(function() {
      $('#datosmensuales_details').removeClass('active in');
      $('#datosanuales_details').removeClass('active in');
      $('#datospersonales_details').addClass('active in');
    });
  ...
  function graficar(meses, cantSobrepeso, cantNormal, cantDelgadez, cantObesidad, year) {
    Highcharts.chart('grafico', {
      ...
      title: {
        text: 'Monto acumulado de los meses'
      },
      subtitle: {
        text: 'Año:' + year
      },
