  ...
  $(document).ready(function() {
    ...
    $('#btn_login_details').click(function() {
      ...
      if ($.trim($('#grado').val()).length == 0) {
        ...
        $("ol").append("<div class='alert alert-danger alert-dismissible'> <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><p><i class='icon fa fa-ban'></i>Seleccione un Grado</p></div>");
      } else {
        error_grado = '';
      ...
      if ($.trim($('#arma').val()).length == 0) {
        ...
        $("ol").append("<div class='alert alert-danger alert-dismissible'> <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><p><i class='icon fa fa-ban'></i>Seleccione un Arma</p></div>");
      } else {
        error_arma = '';
      ...
      if ($.trim($('#apellido_pat').val()).length == 0) {
        ...
        $("ol").append("<div class='alert alert-danger alert-dismissible'> <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><p><i class='icon fa fa-ban'></i>Complete Apellido Paterno</p></div>");
      } else {
        error_apelPaterno = '';
      ...
      if ($.trim($('#apellido_mat').val()).length == 0) {
        ...
        $("ol").append("<div class='alert alert-danger alert-dismissible'> <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><p><i class='icon fa fa-ban'></i>Complete Apellido Materno</p></div>");
      } else {
        error_apelPaterno = '';
      ...
      if ($.trim($('#nombres').val()).length == 0) {
        ...
        $("ol").append("<div class='alert alert-danger alert-dismissible'> <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><p><i class='icon fa fa-ban'></i>Complete Nombres</p></div>");
      } else {
        error_apelPaterno = '';
      ...
      if ($.trim($('#estado_civ').val()).length == 0) {
        ...
        $("ol").append("<div class='alert alert-danger alert-dismissible'> <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><p><i class='icon fa fa-ban'></i>Seleccione Estado civil</p></div>");
      } else {
        error_estCivil = '';
      ...
      if ($.trim($('#a_servicio').val()).length == 0) {
        ...
        $("ol").append("<div class='alert alert-danger alert-dismissible'> <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><p><i class='icon fa fa-ban'></i>Complete Años de Servicio</p></div>");
      } else {
        error_anioServicio = '';
      ...
      if ($.trim($('#grado_ins_per').val()).length == 0) {
        ...
        $("ol").append("<div class='alert alert-danger alert-dismissible'> <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><p><i class='icon fa fa-ban'></i>Seleccione Grado de Instrucción</p></div>");
      } else {
        error_gradInst = '';
      ...
      if ($.trim($('#religion').val()).length == 0) {
        ...
        $("ol").append("<div class='alert alert-danger alert-dismissible'> <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><p><i class='icon fa fa-ban'></i>Complete la Religión</p></div>");
      } else {
        error_religion = '';
      ...
      if ($.trim($('#fec_ult_asc').val()).length == 0) {
        ...
        $("ol").append("<div class='alert alert-danger alert-dismissible'> <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button><p><i class='icon fa fa-ban'></i>Escoga la fecha del último ascenso</p></div>");
      } else {
        error_fecAsc = '';
